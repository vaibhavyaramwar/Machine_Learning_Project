...
class Configuration:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            data_validation_schema_dir = data_validation_config_key[DATA_VALIDATION_SCHEMA_DIR_KEY] 
            schema_file_path = os.path.join(ROOT_DIR,data_validation_schema_dir,data_validation_config_key[DATA_VALIDATION_SCHEMA_FILE_NAME_KEY])


            report_file_path = os.path.join(data_validation_artifact_dir, data_validation_config_key[DATA_VALIDATION_REPORT_FILE_NAME_KEY])
            report_page_file_path  = os.path.join(data_validation_artifact_dir, data_validation_config_key[DATA_VALIDATION_REPORT_FILE_PATH_NAME_KEY])
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            data_transfromation_config_info = self.config_info[DATA_TRANSFORMATION_CONFIG_KEY]

            add_bedroom_per_room = data_transfromation_config_info[DATA_TRANSFORMATION_ADD_BEDROOM_PER_ROOM_KEY]
            
            
            transfomrmed_train_dir = os.path.join(data_transformation_artifact_dir,
                                            data_transfromation_config_info[DATA_TRANSFORMATION_DIR_NAME_KEY],
                                            data_transfromation_config_info[DATA_TRANSFORMATION_TRAIN_DIR_NAME_KEY])

            transformed_test_dir = os.path.join(data_transformation_artifact_dir,
                                                 data_transfromation_config_info[DATA_TRANSFORMATION_DIR_NAME_KEY],
                                                 data_transfromation_config_info[DATA_TRANSFORMATION_TEST_DIR_NAME_KEY])

            preprocessed_object_file_path = os.path.join(data_transformation_artifact_dir,
                    data_transfromation_config_info[DATA_TRANSFORMATION_PREPROCESSING_DIR_KEY],
                    data_transfromation_config_info[DATA_TRANSFORMATION_PREPROCESSED_FILE_NAME_KEY])


            data_transform_config = DataTransformationConfig(add_bedroom_per_room=add_bedroom_per_room,
            transfomrmed_train_dir=transfomrmed_train_dir,
