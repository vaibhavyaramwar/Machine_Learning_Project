...
class DataIngestion:
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:
            ...
            logging.info(f"Extraction of [{tgz_file_path}] into [{raw_data_dir}] is completed")
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
         try:
            ...
            if strat_test_set is not None:
                ...
                logging.info(f"Exporting Testing Data into file : [{test_file_path}]")
                strat_test_set.to_csv(test_file_path,index=False)

            data_ingestion_artifact = DataIngestionArtifact(train_file_path=train_file_path,test_file_path=test_file_path,
                        is_ingested=True,message=f"Data Ingession Completed Successfully")
