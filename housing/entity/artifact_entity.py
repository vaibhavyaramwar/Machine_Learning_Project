...
DataTransformationArtifact = namedtuple("DataTransformationArtifact",["is_transformed","message","transfomrmed_train_file_path","transformed_test_file_path","preprocessed_object_file_path"])
